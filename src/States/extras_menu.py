...
class ExtrasMenu(GenericState):
    ...
    def setup(s):
        ...
        pos_y = 80
        visible_states = ["Extras page 1", "Extras page 2", "Extras page 3"]
        ...
        s.buttons.append(ImageAudioButton(
                s.game,
                (button_image.get_width()//2 + 10, button_image.get_height() + 10),
                button_image,
                hovered_button_image,
                text="Back",
                action=s.back_to_start_menu,
                sound=None,
                text_size=50,
                font=None))

    def back_to_start_menu(s):
